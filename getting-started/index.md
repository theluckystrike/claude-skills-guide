...
<div style="margin-top: 1.5rem; padding: 1.25rem; background: linear-gradient(135deg, #5436DA15, #7c5ce015); border-radius: 12px; border: 1px solid #5436DA30;">
  <strong style="color: #5436DA;">Try our CLAUDE.md Generator →</strong>
  <a href="/generator/" style="color: #333; text-decoration: none; margin-left: 0.5rem;">Generate your first CLAUDE.md configuration</a>
</div>
