---
layout: default
title: "Claude Code Setup on Mac"
...
**[See the templates →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-config&utm_campaign=claude-code-setup-on-mac-step-by-step)**
