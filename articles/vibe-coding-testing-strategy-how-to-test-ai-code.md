...
**Missing error paths** — Happy-path code from AI prompts frequently lacks robust error handling. Targeted tests for failure conditions expose these gaps without requiring exhaustive code review.
