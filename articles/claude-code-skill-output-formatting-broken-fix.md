...
description: "Fix broken output formatting when using Claude Code skills. Covers markdown rendering issues, code block problems, skill instruction mismatches, and terminal vs. IDE display differences."
date: 2026-03-13
