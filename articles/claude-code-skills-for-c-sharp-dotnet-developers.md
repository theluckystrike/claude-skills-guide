...
[The **xlsx** skill handles spreadsheet operations](/claude-skills-guide/articles/claude-code-skills-for-real-estate-listing-platforms/) tracking metrics, test coverage, or sprint data.
...
[The **webapp-testing** skill helps verify frontend functionality](/claude-skills-guide/articles/what-is-the-best-claude-skill-for-automated-code-review/) in ASP.NET Core applications.
...
[Many .NET developers use this to build custom integrations](/claude-skills-guide/articles/mcp-server-creation-with-claude-code-guide/) between Claude Code and internal systems.
...
- [MCP Server Creation with Claude Code Guide](/claude-skills-guide/articles/mcp-server-creation-with-claude-code-guide/) — build custom MCP servers for .NET service integrations
- [What Is the Best Claude Skill for Automated Code Review](/claude-skills-guide/articles/what-is-the-best-claude-skill-for-automated-code-review/) — add automated code review to your .NET development workflow
- [Claude Code Skills for Golang Microservices](/claude-skills-guide/articles/claude-code-skills-for-golang-microservices/) — compare microservice patterns across languages
