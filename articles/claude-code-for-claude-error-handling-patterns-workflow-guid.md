...
| Input might be dangerous or malformed | Defensive validation, fail fast |
...
**[See what prevents these errors →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-error&utm_campaign=claude-code-for-claude-error-handling-patterns-workflow-guid)**
