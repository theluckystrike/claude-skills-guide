---
title: "Claude Code vs Windsurf: Cost-Per-Feature Breakdown"
...
- [Claude Code Max Subscription Guide](/claude-code-max-subscription-guide/) -- full guide to the Max plan
