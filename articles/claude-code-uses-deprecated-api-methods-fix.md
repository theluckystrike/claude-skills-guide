...
```
The 'messages' endpoint parameter 'max_tokens_to_sample' is deprecated. Use 'max_tokens' instead.
```
...
**[Grab the templates — $99 once, free forever →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-error&utm_campaign=claude-code-uses-deprecated-api-methods-fix)**
