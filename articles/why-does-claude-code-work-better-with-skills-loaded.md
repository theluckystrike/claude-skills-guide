...
A fair question is whether you could get the same effect by writing a detailed prompt at the start of each session. The answer is: partially, but not fully, for three reasons.
