...
description: "Learn how to use Claude Code with HashiCorp Vault's Transit secrets engine for encryption as a service. Practical examples for developers implementing data encryption."
date: 2026-03-15
categories: [guides]
