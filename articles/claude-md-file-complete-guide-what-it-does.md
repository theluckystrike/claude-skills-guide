---
layout: default
title: "Claude Md File: What It Does"
...
The `description` field provides a brief explanation of what the skill does. This appears in skill listings and helps Claude determine when a skill is relevant to your request.
...
**[See how the pipeline works →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-skills&utm_campaign=claude-md-file-complete-guide-what-it-does)**
