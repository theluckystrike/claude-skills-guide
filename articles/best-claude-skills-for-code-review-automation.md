...
The [`tdd` skill](/claude-skills-guide/articles/best-claude-skills-for-developers-2026/) is the most direct tool for review automation. Rather than reviewing untested code and hoping for the best, use it to verify test coverage before approving a PR.
...
The [`supermemory` skill](/claude-skills-guide/articles/claude-skills-token-optimization-reduce-api-costs/) maintains institutional knowledge across review sessions. Store your team's established conventions once, then recall them in every review.
