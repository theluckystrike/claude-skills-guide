---
layout: default
title: "Claude Code For Sprint Start — Complete Developer Guide"
...
```bash
Invoke a sprint-prep skill with your backlog context
...
The [tdd skill is particularly valuable here](/claude-tdd-skill-test-driven-development-workflow/). Invoke it during planning to generate test cases alongside your story breakdown:
...
**[See what's inside →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-default&utm_campaign=claude-code-for-sprint-start-workflow-tips)**
