---
layout: default
title: "Claude Code Dotfiles Management (2026)"
...
For manual refresh, you can invoke a built-in command if available, or simply start a new session. [When you modify a skill like `tdd-workflow.md`](/claude-tdd-skill-test-driven-development-workflow/):
...
**[See how the pipeline works →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-skills&utm_campaign=claude-code-dotfiles-management-and-skill-sync-workflow)**
