...
The free version includes most essential features, though it has character limits per check (around 20,000 characters) and some advanced style rules are premium-only. LanguageTool also offers a desktop app and browser extension that works seamlessly with Google Docs, Gmail, Notion, and most other web platforms.
...
ProWritingAid offers some of the most robust analysis of any free tool:
