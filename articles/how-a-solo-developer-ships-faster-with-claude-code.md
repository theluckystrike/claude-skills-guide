...
Deployment infrastructure takes time to configure correctly. The **github-actions** skill generates production-ready CI/CD pipelines:

```yaml
# Generated by github-actions skill
...
Master one skill before adding others. Each skill has its own learning curve, and深度 expertise in fewer skills outperforms surface-level adoption of many.
