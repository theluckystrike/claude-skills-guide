...
Note: This grants the container full Docker access on the host—use only with trusted images. The container can control the host Docker daemon completely, which is a significant security boundary to cross.
