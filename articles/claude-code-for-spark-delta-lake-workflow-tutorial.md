...
- [Claude Code for Delta Lake Schema Evolution Workflow](/claude-skills-guide/claude-code-for-delta-lake-schema-evolution-workflow/) — deep dive into detecting, migrating, and auditing schema changes specifically
