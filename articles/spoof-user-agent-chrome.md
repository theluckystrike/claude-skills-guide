...
**Important**: You must quit all existing Chrome windows first. Chrome is a single-process application by default — if any Chrome instance is already running, the new window will join the existing process and ignore the flag.
