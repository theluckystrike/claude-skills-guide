...
The gray scale tokens automatically shift — `--gray-1` becomes very dark and `--gray-12` becomes very light in dark mode. This means any component built with the gray scale adapts to dark mode without additional CSS. Prompt Claude Code to leverage this behavior explicitly:
