...
description: "Learn how to use Claude Code with Xata's serverless database branching to create isolated development environments, test schema changes safely, and streamline your development workflow."
date: 2026-03-14
categories: [guides]
