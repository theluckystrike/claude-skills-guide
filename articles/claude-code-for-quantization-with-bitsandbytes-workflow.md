...
For maximum memory savings, 4-bit quantization offers even greater压缩. This approach uses NF4 (Normal Float 4) format, which is optimized for neural network weights:
