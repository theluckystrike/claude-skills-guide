...
description: "A practical guide to using Claude MD templates for new projects. Learn how to structure prompts, leverage Claude skills like tdd, pdf, frontend-design, and supermemory for faster development."
date: 2026-03-14
categories: [guides]
tags: [claude-code, claude-skills, md-template, starter-guide, prompt-engineering]
