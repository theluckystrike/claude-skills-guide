...
For LLM inference, CPU utilization is a poor scaling signal — the bottleneck is GPU. A better approach uses a custom metric based on queue depth or active request count:
