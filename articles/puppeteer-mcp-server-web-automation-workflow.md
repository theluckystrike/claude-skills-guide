...
Similarly, [combining with the `tdd` skill allows you to write browser-based tests](/claude-tdd-skill-test-driven-development-workflow/) that verify UI behavior:
...
**[Get the Claude Code Mastery Bundle — included free in Zovo Lifetime →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=article&utm_campaign=puppeteer-mcp-server-web-automation-workflow)**
