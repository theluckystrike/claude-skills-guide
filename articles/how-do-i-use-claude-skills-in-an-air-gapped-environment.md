---
layout: default
title: "Use Claude Skills in Air-Gapped (2026)"
...
```python
Extract text from a classified document
...
**[See how the pipeline works →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-skills&utm_campaign=how-do-i-use-claude-skills-in-an-air-gapped-environment)**
