...
**Important**: Run Lighthouse in an incognito window or a fresh Chrome profile to avoid extensions inflating or deflating your scores. Extensions that inject scripts, modify cookies, or intercept requests change what Lighthouse measures.
