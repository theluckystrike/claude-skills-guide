...
```
/supermemory Remember: "submit button" translations. es: botón de enviar, fr: bouton soumettre, ja: 
```
...
**[See the setup that ships →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-default&utm_campaign=claude-code-l10n-testing-automation-workflow-tutorial)**
