---
title: "How to Measure Context Efficiency in Claude Code Sessions"
...
- [Claude Code Compact Command Guide](/claude-code-compact-command-guide/) -- the top tool for improving efficiency mid-session
