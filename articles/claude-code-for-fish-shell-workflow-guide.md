...
### How do I get started with claude code for fish shell?
...
- [Claude Code for Atuin Shell History](/claude-code-for-atuin-shell-history-workflow/)
- [Claude Code for Shell Operator Workflow](/claude-code-for-shell-operator-workflow-tutorial/)
