---
title: "Claude Code subagent spawning too many agents — cost control"
...
- [Claude Code Subagent Management](/claude-code-subagent-management/) -- complete subagent reference
