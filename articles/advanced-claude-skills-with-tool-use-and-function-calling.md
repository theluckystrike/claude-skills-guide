...
report.md -> output/report-2026-03-13.pdf
...
**[See how the pipeline works →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-skills&utm_campaign=advanced-claude-skills-with-tool-use-and-function-calling)**
...
### What is Declaring Tool Requirements?

See the dedicated section above for a detailed explanation covering practical implementation, best practices, and specific examples relevant to this topic.

### What is Guiding Tool Use in the Skill Body?

See the dedicated section above for a detailed explanation covering practical implementation, best practices, and specific examples relevant to this topic.

### How do you specify when to read files?

See the dedicated section above for a detailed explanation covering practical implementation, best practices, and specific examples relevant to this topic.

### How do you specify bash command patterns?
