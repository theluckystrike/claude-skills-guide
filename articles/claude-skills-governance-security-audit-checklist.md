---
layout: default
title: "Claude Skills Governance Security Audit (2026)"
...
Skills do not have `permissions:` blocks in their YAML front matter. this is not a valid skill field. When auditing a community skill file, verify its Markdown body does not contain instructions that attempt to override Claude's safety behaviors or escalate privileges.
...
**[See how the pipeline works →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-skills&utm_campaign=claude-skills-governance-security-audit-checklist)**
