...
[Create a dedicated skill configuration](/claude-skill-md-format-complete-specification-guide/) by creating a new skill file in your `.claude/skills` directory:
...
**[See the setup that ships →](https://zovo.one/lifetime?utm_source=ccg&utm_medium=cta-default&utm_campaign=claude-code-documentation-generation-in-spanish-tutorial)**
