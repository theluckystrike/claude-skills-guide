...
Create a dedicated skill configuration for Spanish documentation by creating a new skill file in your `.claude/skills` directory:
...
API documentation requires consistent terminology and structure. The **pdf** skill works well for generating formatted API docs:
...
When generating Spanish documentation across multiple sessions, maintaining consistent terminology matters. The **supermemory** skill stores your preferences:
