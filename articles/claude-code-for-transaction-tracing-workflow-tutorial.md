...
Imagine you are getting customer complaints that checkout is slow — sometimes 8 seconds, usually 2 seconds. You have tracing in place. Here is how Claude Code helps you work through it.

First, pull a slow trace from Jaeger by filtering for `checkout_transaction` spans with duration over 5 seconds. Export the JSON and paste the span breakdown into Claude Code with the prompt: "Here is a slow trace from our checkout flow. What stands out?"
