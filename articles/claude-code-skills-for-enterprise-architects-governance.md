...
The **tdd** skill enforces test-driven development practices by scaffold ing tests before implementation code. For governance, this means ensuring every feature has corresponding test coverage before merge approval.
